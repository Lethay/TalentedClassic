...
L["http://classic.wowhead.com/talent-calc/%s/%s"] = "http://www.classic.wowhead.com/talent-calc/%s/%s"
...
L["Make a copy of the current template."] = "지금 당신이 보기있는 템플릿을 복제하여 만듭니다."
